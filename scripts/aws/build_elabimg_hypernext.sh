...
# Fix Scheduler.php: EVENT_START/EVENT_END had month/day swapped and used ISO format MySQL can't parse
RUN sed -i "s|'2012-31-12T00:00:00+00:00'|'2012-12-31 00:00:00'|g; s|'2037-31-12T00:00:00+00:00'|'2037-12-31 00:00:00'|g" /elabftw/src/Models/Scheduler.php
# Fix normalizeDate to accept ATOM/MySQL/date-only input and always output MySQL Y-m-d H:i:s format
RUN php -r "
...
PHP;
echo (strpos(\$src, \$old) !== false ? 'Patching normalizeDate...' : 'WARNING: normalizeDate pattern not found, skipping') . PHP_EOL;
