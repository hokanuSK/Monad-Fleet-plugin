...
\begin{itemize}
  ...
  \begin{itemize}
    \item \texttt{src/observability/grafana/provisioning/dashboards/monad-fleet.yml}
    \item \texttt{src/observability/grafana/provisioning/dashboards/monad-fleet-wireless-sensing-v3.json}
  \end{itemize}
\end{itemize}
