...
\begin{itemize}
  \item v2 protobuf: \texttt{proto/fleet\_gateway\_v2.proto}
  \item server implementation: \texttt{apps/fleet-service/gateway\_server.py}
  \item reference client: \texttt{apps/device-sim/agent\_v2\_client.py}
  \item legacy v1 protobuf (still served): \texttt{proto/fleet\_gateway.proto}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item \texttt{infra/observability/grafana/provisioning/dashboards/monad-fleet.yml}
    \item \texttt{infra/observability/grafana/provisioning/dashboards/monad-fleet-wireless-sensing-v3.json}
  \end{itemize}
\end{itemize}
