...
| `docs/adr/0001-repo-layout-normalization-2026-03-24.md` | ADR | Repository structure normalization and compatibility strategy | You need rationale for current `apps/` + `infra/` + `artifacts/` layout. |
| `docs/runbooks/repo-layout.md` | Runbook | Canonical path usage and migration compatibility notes | You are updating scripts/docs and need canonical path guidance. |
